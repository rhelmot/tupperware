...
public class BorderLayout implements LayoutManager {
    ...
    public void doLayout(TerminalSize area, List<Component> components) {
        ...
        if(layout.containsKey(Location.BOTTOM)) {
            ...
            //System.err.println("got that shit: " + new Integer(bottomComponentHeight).toString());
            //System.err.println("laying out bottom component at position " + bottomComponent.getPosition().toString() + " and size " + bottomComponent.getSize().toString());
        }
        ...
        if(layout.containsKey(Location.CENTER)) {
            ...
            //System.err.println("laying out center component at position " + centerComponent.getPosition().toString() + " and size " + centerComponent.getSize().toString());
        }
